...
\begin{itemize}
	\item Introducing a segment-aware transformer~(Segatron) for language modeling and understanding.
	\item Achieving SOTA results in language modeling. BERT pre-trained with Segatron outperformers the original BERT on GLUE and SQUAD, and outperforms RoBERTa on sentence representation learning.
\end{itemize}
}
...
\begin{itemize}
	\item Transferring spoken language understanding dataset from Chinese to English with RL-based machine translation method.
\end{itemize}
}
...
\cvitem{$\bullet$}{Minghan Li, \textbf{He Bai}, He Bai, Luchen Tan, Kun Xiong, Jimmy Lin \textbf{Latte-Mix: Measuring Sentence Semantic Similarity with Latent Categorical Mixtures.} \textit{arXiv preprint arXiv:2010.11351~(under review).}}
...
\section{Insterests}
\cvitem{Research}{Text representation learning, Language modeling}
